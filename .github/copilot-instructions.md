...
1. **Initialize Next.js 14 Project:**
   ...
   - When prompted, answer: Yes to TypeScript, Yes to ESLint, Yes to TailwindCSS, No to App Router, Yes to src/ directory, Yes to import alias
...
- **Development server:** `npm run dev`
  - NEVER CANCEL: Starts immediately, runs continuously. Set timeout to 60+ minutes.
  - Available at http://localhost:3000
  - Hot reload enabled for development

- **Production build:** `npm run build`
  - NEVER CANCEL: Takes 5-15 minutes depending on codebase size. Set timeout to 30+ minutes.
...
5. Take a screenshot to document the working state
...
- **npm run dev startup:** 10-30 seconds
- **npm run build:** 5-15 minutes (NEVER CANCEL)
- **npm run lint:** 30-120 seconds
